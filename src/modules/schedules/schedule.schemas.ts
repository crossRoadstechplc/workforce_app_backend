...
const checkoutAfterCheckIn = (value: { checkInTime?: string; checkOutTime?: string }, ctx: z.RefinementCtx) => {
...
export const createScheduleSchema = scheduleObject.superRefine(checkoutAfterCheckIn);
export const updateScheduleSchema = scheduleObject
  .partial()
  .refine((value) => Object.keys(value).length > 0, "At least one field is required")
  .superRefine(checkoutAfterCheckIn);
