...
adminDashboardRouter.use(authenticate, requireNormalSession, requireOrgContext, requirePermission("report.view"));
...
adminReportRouter.use(authenticate, requireNormalSession, requireOrgContext, requirePermission("report.view"));
