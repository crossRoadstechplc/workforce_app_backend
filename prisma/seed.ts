...
const permissions=["employee.create","employee.view","employee.update","employee.deactivate","office.manage","schedule.manage","attendance.check_in","attendance.check_out","attendance.view_own","attendance.view_all","attendance.correct","worksheet.create","worksheet.view_own","worksheet.view_all","leave.request","leave.view_own","leave.view_all","leave.approve","leave.reject","notification.view","report.view","report.export","audit.view"];
async function main(){
